...
EASYRPG_STRUCT_FIELD_MAP_BEGIN(SaveMapEvent)
	, EASYRPG_TYPED_FIELD_PAIR(int, unknown_01, ('unkn')('own_')('01'))
	...
	, EASYRPG_TYPED_FIELD_PAIR(int, anim_frame, ('anim')('_fra')('me'))
	, EASYRPG_TYPED_FIELD_PAIR(int, unknown_18, ('unkn')('own_')('18'))
	, EASYRPG_TYPED_FIELD_PAIR(int, unknown_1f, ('unkn')('own_')('1f'))
	, EASYRPG_TYPED_FIELD_PAIR(int, unknown_20, ('unkn')('own_')('20'))
	, EASYRPG_TYPED_FIELD_PAIR(int, layer, ('laye')('r'))
	, EASYRPG_TYPED_FIELD_PAIR(int, unknown_22, ('unkn')('own_')('22'))
	...
	, EASYRPG_TYPED_FIELD_PAIR(int, anim_paused, ('anim')('_pau')('sed'))
	...
	, EASYRPG_TYPED_FIELD_PAIR(int, unknown_47, ('unkn')('own_')('47'))
	...
	, EASYRPG_TYPED_FIELD_PAIR(int, unknown_66, ('unkn')('own_')('66'))
	, EASYRPG_TYPED_FIELD_PAIR(int, unknown_67, ('unkn')('own_')('67'))
	, EASYRPG_TYPED_FIELD_PAIR(RPG::SaveEventData, event_data, ('even')('t_da')('ta'))
