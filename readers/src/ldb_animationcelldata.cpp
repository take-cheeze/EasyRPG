...
////////////////////////////////////////////////////////////
std::auto_ptr<RPG::AnimationCellData> LDB_Reader::ReadAnimationCellData(Reader& stream) {
	std::auto_ptr<RPG::AnimationCellData> celldata(new RPG::AnimationCellData);
