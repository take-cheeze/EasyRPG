...
/// Read Save Cover
////////////////////////////////////////////////////////////
std::auto_ptr<RPG::SavePartyLocation> LSD_Reader::ReadSavePartyLocation(Reader& stream) {
	std::auto_ptr<RPG::SavePartyLocation> location(new RPG::SavePartyLocation);
