...
/// Read Save Cover
////////////////////////////////////////////////////////////
std::auto_ptr<RPG::SaveVehicleLocation> LSD_Reader::ReadSaveVehicleLocation(Reader& stream) {
	std::auto_ptr<RPG::SaveVehicleLocation> location(new RPG::SaveVehicleLocation);
