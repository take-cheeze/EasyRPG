...
public:
	...
	////////////////////////////////////////////////////////
	static std::auto_ptr<Bitmap> CreateBitmap(int width, int height, const Color& color);
	...
	////////////////////////////////////////////////////////
	static std::auto_ptr<Bitmap> CreateBitmap(const std::string& filename, bool transparent = true, uint32 flags = 0);
	...
	/// @param transparent : allow transparency on bitmap
	////////////////////////////////////////////////////////
	static std::auto_ptr<Bitmap> CreateBitmap(const uint8* data, uint bytes, bool transparent = true, uint32 flags = 0);
	...
	/// @param transparent : allow transparency on bitmap
	////////////////////////////////////////////////////////
	static std::auto_ptr<Bitmap> CreateBitmap(Bitmap* source, Rect src_rect, bool transparent = true);
