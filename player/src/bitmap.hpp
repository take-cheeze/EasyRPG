...
public:
	...
	////////////////////////////////////////////////////////
	static std::auto_ptr<Bitmap> CreateBitmap(int width, int height, bool transparent = true);
	...
	/// @param transparent : allow transparency on bitmap
	////////////////////////////////////////////////////////
	static std::auto_ptr<Bitmap> CreateBitmap(const std::string filename, bool transparent = true);
	...
	/// @param transparent : allow transparency on bitmap
	////////////////////////////////////////////////////////
	static std::auto_ptr<Bitmap> CreateBitmap(const uint8* data, uint bytes, bool transparent = true);
