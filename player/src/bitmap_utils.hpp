...
public:
	...
	////////////////////////////////////////////////////////
	virtual std::auto_ptr<Bitmap> Resample(Bitmap* src, int scale_w, int scale_h, const Rect& src_rect) = 0;
	...
	/// @param scale_h : resampled height
	////////////////////////////////////////////////////////
	virtual std::auto_ptr<Bitmap> RotateScale(Bitmap* src, double angle, int scale_w, int scale_h) = 0;
	...
	////////////////////////////////////////////////////////
	virtual std::auto_ptr<Bitmap> Waver(Bitmap* src, int depth, double phase) = 0;
	...
	////////////////////////////////////////////////////////
	static std::auto_ptr<BitmapUtils> Create(int bpp, bool has_alpha, bool has_colorkey,
...
public:
	...
	std::auto_ptr<Bitmap> Resample(Bitmap* src, int scale_w, int scale_h, const Rect& src_rect);
	std::auto_ptr<Bitmap> RotateScale(Bitmap* src, double angle, int scale_w, int scale_h);
	std::auto_ptr<Bitmap> Waver(Bitmap* src, int depth, double phase);
