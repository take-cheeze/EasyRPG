...
/*void Scene_Map::TransitionIn() {
	Graphics::Transition((Graphics::TransitionType)Data::database.system.transition_in, 12);
}

void Scene_Map::TransitionOut() {
	Graphics::Transition((Graphics::TransitionType)Data::database.system.transition_in, 12, true);
}*/
