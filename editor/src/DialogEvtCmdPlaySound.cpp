...
DialogEvtCmdPlaySound::DialogEvtCmdPlaySound(wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, long WXUNUSED(style)):
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxMAXIMIZE_BOX|wxMINIMIZE_BOX)
{
    // begin wxGlade: DialogEvtCmdPlaySound::DialogEvtCmdPlaySound
    ...
    const wxString *listSound_choices = NULL;
    listSound = new wxListBox(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, listSound_choices, 0);
...
void DialogEvtCmdPlaySound::set_properties()
{
    // begin wxGlade: DialogEvtCmdPlaySound::set_properties
    SetTitle(_("Play sound"));
    listSound->SetMinSize(wxSize(150,-1));
    btnOK->SetDefault();
    // end wxGlade
}


void DialogEvtCmdPlaySound::do_layout()
{
    // begin wxGlade: DialogEvtCmdPlaySound::do_layout
    wxBoxSizer* szPlaySound = new wxBoxSizer(wxVERTICAL);
