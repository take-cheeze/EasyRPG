...
DialogEvtCmdEquipment::DialogEvtCmdEquipment(wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, long WXUNUSED(style)):
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxMAXIMIZE_BOX|wxMINIMIZE_BOX|wxTHICK_FRAME)
{
    ...
    const wxString *chOperandConstant_choices = NULL;
    chOperandConstant = new wxChoice(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chOperandConstant_choices, 0);
...
void DialogEvtCmdEquipment::do_layout()
{
    ...
    gszOperand->Add(chOperandConstant, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL, 0);
