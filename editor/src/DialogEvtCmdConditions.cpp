...
DialogEvtCmdConditions::DialogEvtCmdConditions(wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, long WXUNUSED(style)):
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxMAXIMIZE_BOX|wxMINIMIZE_BOX|wxTHICK_FRAME)
{
    ...
    szConditionsTop_staticbox = new wxStaticBox(this, -1, _("Conditions"));
    ...
    const wxString *chSwitch_choices = NULL;
    chSwitch = new wxChoice(pnConditions1, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chSwitch_choices, 0);
    ...
    const wxString *chVariable_choices = NULL;
    chVariable = new wxChoice(pnConditions1, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chVariable_choices, 0);
    ...
    const wxString *chTimer_choices = NULL;
    chTimer = new wxChoice(pnConditions1, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chTimer_choices, 0);
    ...
    const wxString *chMoney_choices = NULL;
    chMoney = new wxChoice(pnConditions1, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chMoney_choices, 0);
    rbtnItem = new wxRadioButton(nbConditions2, wxID_ANY, _("Item"));
    const wxString *chItem_choices = NULL;
    chItem = new wxChoice(nbConditions2, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chItem_choices, 0);
    const wxString *chItem2_choices = NULL;
    chItem2 = new wxChoice(nbConditions2, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chItem2_choices, 0);
    rbtnoActor = new wxRadioButton(nbConditions2, wxID_ANY, _("Actor"));
    const wxString *chActor_choices = NULL;
    chActor = new wxChoice(nbConditions2, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chActor_choices, 0);
    ...
    const wxString *chGroup_choices = NULL;
    chGroup = new wxChoice(nbConditions2, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chGroup_choices, 0);
    stGroup = new wxStaticText(nbConditions2, wxID_ANY, _(":"));
    const wxString *chGroup2_choices = NULL;
    chGroup2 = new wxChoice(nbConditions2, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chGroup2_choices, 0);
    ...
    const wxString *chVehicle_choices = NULL;
    chVehicle = new wxChoice(nbConditions2, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chVehicle_choices, 0);
...
void DialogEvtCmdConditions::do_layout()
{
    ...
    gszConditions1->Add(rbtnSwitch, 0, wxLEFT|wxTOP|wxALIGN_CENTER_VERTICAL, 1);
    ...
    gszConditions1->Add(szSwitch, 1, wxTOP|wxBOTTOM|wxEXPAND, 1);
    gszConditions1->Add(rbtnVariable, 0, wxLEFT|wxALIGN_CENTER_VERTICAL, 1);
    ...
    gszConditions1->Add(szVariable, 1, wxTOP|wxEXPAND, 1);
    gszConditions1->Add(0, 0, 1, wxEXPAND, 0);
    gszVariable->Add(rbtnVariableFixed, 0, wxALIGN_CENTER_VERTICAL, 0);
    gszVariable->Add(spinVariableFiexd, 1, wxEXPAND|wxALIGN_CENTER_VERTICAL, 1);
    ...
    gszConditions1->Add(0, 0, 1, wxEXPAND, 0);
    gszConditions1->Add(chVariable, 0, wxRIGHT|wxTOP|wxBOTTOM|wxEXPAND|wxALIGN_CENTER_VERTICAL, 1);
    gszConditions1->Add(rbtnTimer, 0, wxLEFT|wxALIGN_CENTER_VERTICAL, 1);
    ...
    gszConditions1->Add(szTimer, 1, wxTOP|wxBOTTOM|wxEXPAND, 1);
    gszConditions1->Add(rbtnMoney, 0, wxLEFT|wxBOTTOM|wxALIGN_CENTER_VERTICAL, 1);
    szMoney->Add(spinMoney, 0, wxRIGHT|wxBOTTOM, 1);
    szMoney->Add(chMoney, 3, wxLEFT|wxRIGHT|wxBOTTOM|wxALIGN_CENTER_VERTICAL, 1);
    gszConditions1->Add(szMoney, 1, wxTOP|wxBOTTOM|wxEXPAND, 1);
