...
DialogEvtCmdVehiclePosition::DialogEvtCmdVehiclePosition(wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, long WXUNUSED(style)):
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxMAXIMIZE_BOX|wxMINIMIZE_BOX|wxTHICK_FRAME)
{
    // begin wxGlade: DialogEvtCmdVehiclePosition::DialogEvtCmdVehiclePosition
    szPosition_staticbox = new wxStaticBox(this, -1, _("Vehicle position"));
...
void DialogEvtCmdVehiclePosition::set_properties()
{
    // begin wxGlade: DialogEvtCmdVehiclePosition::set_properties
...
void DialogEvtCmdVehiclePosition::do_layout()
{
    // begin wxGlade: DialogEvtCmdVehiclePosition::do_layout
