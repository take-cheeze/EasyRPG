...
DialogEvtCmdLevel::DialogEvtCmdLevel(wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, long WXUNUSED(style)):
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxMAXIMIZE_BOX|wxMINIMIZE_BOX)
{
    // begin wxGlade: DialogEvtCmdLevel::DialogEvtCmdLevel
...
void DialogEvtCmdLevel::set_properties()
{
    // begin wxGlade: DialogEvtCmdLevel::set_properties
...
void DialogEvtCmdLevel::do_layout()
{
    // begin wxGlade: DialogEvtCmdLevel::do_layout
