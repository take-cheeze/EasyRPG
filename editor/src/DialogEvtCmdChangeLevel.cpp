...
#include "DialogEvtCmdChangeLevel.h"
...
DialogEvtCmdChangeLevel::DialogEvtCmdChangeLevel(wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, long WXUNUSED(style)):
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxMAXIMIZE_BOX|wxMINIMIZE_BOX|wxTHICK_FRAME)
{
    // begin wxGlade: DialogEvtCmdChangeLevel::DialogEvtCmdChangeLevel
    ...
    chbShowMessage = new wxCheckBox(this, wxID_ANY, _("Show message of level up"));
...
void DialogEvtCmdChangeLevel::set_properties()
{
    // begin wxGlade: DialogEvtCmdChangeLevel::set_properties
...
void DialogEvtCmdChangeLevel::do_layout()
{
    // begin wxGlade: DialogEvtCmdChangeLevel::do_layout
    wxBoxSizer* szLevel = new wxBoxSizer(wxVERTICAL);
