...
DialogEvtCmdTeleportPlace::DialogEvtCmdTeleportPlace(wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, long WXUNUSED(style)):
