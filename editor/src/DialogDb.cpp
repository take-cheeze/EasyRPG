    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxMAXIMIZE_BOX|wxMINIMIZE_BOX)
{
    ...
    btnTroopBattleEventsNewPage = new wxButton(pnTroop, wxID_ANY, _("New page"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT);
    btnTroopBattleEventsCopyPage = new wxButton(pnTroop, wxID_ANY, _("Copy"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT);
    btnTroopBattleEventsPastePage = new wxButton(pnTroop, wxID_ANY, _("Paste"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT);
    btnTroopBattleEventsDeletePage = new wxButton(pnTroop, wxID_ANY, _("Delete"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT);
    ...
    stAttributeEffectRateA = new wxStaticText(pnAttribute, wxID_ANY, _("A"));
    SpinAttributeEffectRateA = new wxSpinCtrl(pnAttribute, wxID_ANY, wxT(""), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100);
    stAttributeEffectRateAPercent = new wxStaticText(pnAttribute, wxID_ANY, _("%"));
    stAttributeEffectRateB = new wxStaticText(pnAttribute, wxID_ANY, _("B"));
    SpinAttributeEffectRateB = new wxSpinCtrl(pnAttribute, wxID_ANY, wxT(""), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100);
    stAttributeEffectRateBPercent = new wxStaticText(pnAttribute, wxID_ANY, _("%"));
    stAttributeEffectRateC = new wxStaticText(pnAttribute, wxID_ANY, _("C"));
    SpinAttributeEffectRateC = new wxSpinCtrl(pnAttribute, wxID_ANY, wxT(""), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100);
    stAttributeEffectRateCPercent = new wxStaticText(pnAttribute, wxID_ANY, _("%"));
    stAttributeEffectRateD = new wxStaticText(pnAttribute, wxID_ANY, _("D"));
    SpinAttributeEffectRateD = new wxSpinCtrl(pnAttribute, wxID_ANY, wxT(""), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100);
    stAttributeEffectRateDPercent = new wxStaticText(pnAttribute, wxID_ANY, _("%"));
    stAttributeEffectRateE = new wxStaticText(pnAttribute, wxID_ANY, _("E"));
    SpinAttributeEffectRateE = new wxSpinCtrl(pnAttribute, wxID_ANY, wxT(""), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100);
    stAttributeEffectRateEPercent = new wxStaticText(pnAttribute, wxID_ANY, _("%"));
    ...
    btnAnimationFramesPrevious = new wxButton(pnAnimation, wxID_ANY, _("&Previous"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT);
...
void DialogDb::do_layout()
{
    ...
    wxFlexGridSizer* gszAttributeEffectRate = new wxFlexGridSizer(5, 3, 2, 2);
    ...
    szTroopBattleEventsTop->Add(btnTroopBattleEventsNewPage, 1, wxRIGHT|wxBOTTOM, 1);
    szTroopBattleEventsTop->Add(btnTroopBattleEventsCopyPage, 1, wxLEFT|wxRIGHT|wxBOTTOM, 1);
    szTroopBattleEventsTop->Add(btnTroopBattleEventsPastePage, 1, wxLEFT|wxRIGHT|wxBOTTOM, 1);
    szTroopBattleEventsTop->Add(btnTroopBattleEventsDeletePage, 1, wxLEFT|wxBOTTOM, 1);
    ...
    gszAttributeEffectRate->Add(stAttributeEffectRateA, 0, wxALIGN_CENTER_VERTICAL, 0);
    gszAttributeEffectRate->Add(SpinAttributeEffectRateA, 0, wxEXPAND, 0);
    gszAttributeEffectRate->Add(stAttributeEffectRateAPercent, 0, wxALIGN_CENTER_VERTICAL, 0);
    gszAttributeEffectRate->Add(stAttributeEffectRateB, 0, wxALIGN_CENTER_VERTICAL, 0);
    gszAttributeEffectRate->Add(SpinAttributeEffectRateB, 0, wxEXPAND, 0);
    gszAttributeEffectRate->Add(stAttributeEffectRateBPercent, 0, wxALIGN_CENTER_VERTICAL, 0);
    gszAttributeEffectRate->Add(stAttributeEffectRateC, 0, wxALIGN_CENTER_VERTICAL, 0);
    gszAttributeEffectRate->Add(SpinAttributeEffectRateC, 0, wxEXPAND, 0);
    gszAttributeEffectRate->Add(stAttributeEffectRateCPercent, 0, wxALIGN_CENTER_VERTICAL, 0);
    gszAttributeEffectRate->Add(stAttributeEffectRateD, 0, wxALIGN_CENTER_VERTICAL, 0);
    gszAttributeEffectRate->Add(SpinAttributeEffectRateD, 0, wxEXPAND, 0);
    gszAttributeEffectRate->Add(stAttributeEffectRateDPercent, 0, wxALIGN_CENTER_VERTICAL, 0);
    gszAttributeEffectRate->Add(stAttributeEffectRateE, 0, wxALIGN_CENTER_VERTICAL, 0);
    gszAttributeEffectRate->Add(SpinAttributeEffectRateE, 0, wxEXPAND, 0);
    gszAttributeEffectRate->Add(stAttributeEffectRateEPercent, 0, wxALIGN_CENTER_VERTICAL, 0);
    gszAttributeEffectRate->AddGrowableCol(1);
    szAttributeEffectRate->Add(gszAttributeEffectRate, 1, wxEXPAND, 0);
    ...
    szAnimationFrames->Add(btnAnimationFramesPrevious, 0, wxBOTTOM|wxEXPAND, 1);
