...
DialogEvtCmdGetTerrainID::DialogEvtCmdGetTerrainID(wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, long WXUNUSED(style)):
...
void DialogEvtCmdGetTerrainID::do_layout()
{
    ...
    szGetTerrainID->Add(szStoreVariableID, 0, wxLEFT|wxRIGHT|wxEXPAND, 1);
