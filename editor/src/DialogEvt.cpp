...
DialogEvt::DialogEvt(wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, long WXUNUSED(style)):
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxMAXIMIZE_BOX|wxMINIMIZE_BOX)
{
    ...
    szStartingConditions_staticbox = new wxStaticBox(pnPage, -1, _("Starting Conditions"));
    szGraphic_staticbox = new wxStaticBox(pnPage, -1, _("Selected graphic"));
    szMovement_staticbox = new wxStaticBox(pnPage, -1, _("Movement type"));
    szTrigger_staticbox = new wxStaticBox(pnPage, -1, _("Starting trigger"));
    szPriority_staticbox = new wxStaticBox(pnPage, -1, _("Priority"));
    szAnimation_staticbox = new wxStaticBox(pnPage, -1, _("Animation type"));
    szSpeed_staticbox = new wxStaticBox(pnPage, -1, _("Scroll speed"));
    szEvtCmd_staticbox = new wxStaticBox(pnPage, -1, _("Event commands"));
    ...
    const wxString *chObject_choices = NULL;
    chObject = new wxChoice(pnPage, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chObject_choices, 0);
    ...
    chActor = new wxChoice(pnPage, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chActor_choices, 0);
    ...
    spinTimerSeconds = new wxSpinCtrl(pnPage, wxID_ANY, wxT(""), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100);
    stTimer = new wxStaticText(pnPage, wxID_ANY, _("Remaining"));
    bmpGraphic = new wxStaticBitmap(pnPage, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxSUNKEN_BORDER);
    ...
    const wxString *chMovement_choices = NULL;
    chMovement = new wxChoice(pnPage, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chMovement_choices, 0);
    stMovementRate = new wxStaticText(pnPage, wxID_ANY, _("Rate:"));
    const wxString *chMovementRate_choices = NULL;
    chMovementRate = new wxChoice(pnPage, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chMovementRate_choices, 0);
    btnMovementCreatePath = new wxButton(pnPage, wxID_ANY, _("Create path"));
    const wxString *chTrigger_choices = NULL;
    chTrigger = new wxChoice(pnPage, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chTrigger_choices, 0);
    const wxString *chPriority_choices = NULL;
    chPriority = new wxChoice(pnPage, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chPriority_choices, 0);
    chOverlap = new wxCheckBox(pnPage, wxID_ANY, _("Allow overlap"));
    const wxString *chAnimation_choices = NULL;
    chAnimation = new wxChoice(pnPage, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chAnimation_choices, 0);
    const wxString *chSpeed_choices = NULL;
    chSpeed = new wxChoice(pnPage, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, chSpeed_choices, 0);
    const wxString listEvtCmd_choices[] = {
        _("<>")
    };
    listEvtCmd = new wxListBox(pnPage, wxID_ANY, wxDefaultPosition, wxDefaultSize, 1, listEvtCmd_choices, 0);
...
void DialogEvt::do_layout()
{
    ...
    gszStartingConditions->Add(chbSwitchA, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 1);
    ...
    gszStartingConditions->Add(stSwitchA, 0, wxLEFT|wxBOTTOM|wxALIGN_CENTER_VERTICAL, 1);
    gszStartingConditions->Add(chbSwitchB, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 1);
    ...
    gszStartingConditions->Add(stSwitchB, 0, wxLEFT|wxTOP|wxBOTTOM|wxALIGN_CENTER_VERTICAL, 1);
    gszStartingConditions->Add(chbVariable, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 1);
    ...
    gszStartingConditions->Add(stVariable1, 0, wxLEFT|wxTOP|wxBOTTOM|wxALIGN_CENTER_VERTICAL, 1);
    gszStartingConditions->Add(10, 9, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL, 0);
    ...
    gszStartingConditions->Add(10, 9, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL, 0);
    gszStartingConditions->Add(chbObject, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 1);
    gszStartingConditions->Add(chObject, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 1);
    gszStartingConditions->Add(stObject, 0, wxLEFT|wxTOP|wxBOTTOM|wxALIGN_CENTER_VERTICAL, 1);
    gszStartingConditions->Add(chbActor, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 1);
    gszStartingConditions->Add(chActor, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 1);
    gszStartingConditions->Add(stActor, 0, wxLEFT|wxTOP|wxBOTTOM|wxALIGN_CENTER_VERTICAL, 1);
    gszStartingConditions->Add(chbTimer, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 1);
    ...
    gszStartingConditions->Add(stTimer, 0, wxLEFT|wxTOP|wxALIGN_CENTER_VERTICAL, 1);
    ...
    szPageLeftDownLeft->Add(szGraphic, 0, wxLEFT|wxRIGHT|wxEXPAND, 1);
    ...
    szPageLeftDownLeft->Add(szMovement, 1, wxLEFT|wxRIGHT|wxBOTTOM|wxEXPAND, 1);
    szPageLeftDown->Add(szPageLeftDownLeft, 0, wxEXPAND, 0);
    szTrigger->Add(chTrigger, 1, 0, 0);
    szPageLeftDownRight->Add(szTrigger, 0, wxLEFT|wxRIGHT|wxEXPAND, 1);
    szPriority->Add(chPriority, 0, wxBOTTOM|wxEXPAND, 1);
    szPriority->Add(chOverlap, 0, wxTOP|wxEXPAND, 1);
    szPageLeftDownRight->Add(szPriority, 0, wxLEFT|wxRIGHT|wxEXPAND, 1);
    szAnimation->Add(chAnimation, 1, 0, 0);
    szPageLeftDownRight->Add(szAnimation, 0, wxLEFT|wxRIGHT|wxEXPAND, 1);
    szSpeed->Add(chSpeed, 1, 0, 0);
    szPageLeftDownRight->Add(szSpeed, 0, wxLEFT|wxRIGHT|wxBOTTOM|wxEXPAND, 1);
